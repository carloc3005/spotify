...
const SubscribeModal: React.FC<SubscribeModalProps> = ({ products }) => {
    ...
    <div className="text-center py-8">
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6 mb-4">
        ...
        <div className="text-neutral-400 mb-4">
          Sign up for free to access unlimited music, create playlists, and upload your own songs.
        </div>
        <Button
          onClick={() => {
            subscribeModal.onClose();
          ...
          className="bg-green-500 hover:bg-green-400 text-black font-semibold px-8 py-3"
        >
          Get Started Free
        </Button>
      </div>
  ...
  return (
    <Modal
      title={!user ? "Sign up to enjoy music" : "Upgrade to Premium"}
      description={!user ? "Create an account to start listening to unlimited music" : "Unlock unlimited music and exclusive features"}
