    ...
    return (
        ...
        >
            <div className="w-full mb-4 flex items-center justify-between">
                <div onClick={() => router.back()} className="hidden md:flex gap-x-2 items-center">
                ...
                <div className="flex justify-between items-center gap-x-4">
                    {user ? (<div className="flex gap-x-4 items-center">
                        ...
                        <>
                            <div>
                                <Button onClick={authModal.onOpenSignUp} className="bg-transparent text-neutral-300 font-medium">
                                    Sign Up
                                </Button>
                            </div>
                            <div>
